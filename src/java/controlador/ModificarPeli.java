 ...
 */
@MultipartConfig
public class ModificarPeli extends HttpServlet {
...
/*
        if (nombreP.equals("") || nombreO.equals("") || resena.equals("") || sinopsis.equals("") || portada == null) {
            ...
            ListaCircular<Peliculas> pelis = (ListaCircular<Peliculas>) request.getSession().getAttribute("myUser");

            if (pelis == null) {
                
                pelis = new ListaCircular<Peliculas>();
                pelis.editarPelicula(new Peliculas(accion), p);
                request.setAttribute("img", imgFileName);
                request.getSession().setAttribute("myUser", pelis);
