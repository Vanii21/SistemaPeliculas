 ...
 * @author vanii
 */
public class MostrarDetallePopulares extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(pelis == null){
           ...
           Nodo<Peliculas> pel = pelis.buscarPeliculaP(pe);
           request.getSession().setAttribute("miPeliEncontrada", pel);
        ...
        request.getRequestDispatcher("detallePeliculaPopular.jsp").forward(request, response);
