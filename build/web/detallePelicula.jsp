<%-- 
    ...
    Created on : 18-mar-2022, 21:45:57
    Author     : vanii
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="modelo.Actor"%>
<%@page import="modelo.NodoArbol"%>
    ...
    <body>
                ...
                <nav class="navbar navbar-default navbar-custom">
                    ...
                    <div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav flex-child-menu menu-left">
                            ...
                            <p style="font-size: 50px"><b>DETALLE PELICULA</b></p>
                    ...
                    <div  class="slick-multiItemSlider">
                        ...
                        <div class="movie-item">
                            ...
                            <div class="title-in">
                                ...
                                <a href="detalleactores.do?accion=<%=id%>&accion2=normal&accion3=<%=nom%>"><h6><%=nom%></h6></a>
        ...
        <div class="slider movie-items">
            <div class="container">
                <div class="row" >
                    <div>
                        <form action="eliminarpeli.do?accion=<%=nomP%>" method="post" enctype="multipart/form-data">
                            <input type="submit" value="Eliminar Pelicula" class="boton_personalizado"> 
                        </form>
                        <br>
                        <form action="editarPeli.jsp?accion=<%=nomP%>" method="post" enctype="multipart/form-data">
