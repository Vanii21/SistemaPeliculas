<%-- 
    Document   : editarPelisP
    Created on : 25-mar-2022, 1:24:50
    Author     : vanii
--%>
...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        String nomP = request.getParameter("accion");
        ...
        <div class="slider movie-items">
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-lg-6">
                        <form action="editarpelip.do?accion=<%=nomP%>" method="post" enctype="multipart/form-data">
                            ...
                            <br />
                            <input type="submit" value="Modificar" class="boton_personalizado"/>
                        </form>
                    </div>
                    <div class="col-lg-6">
